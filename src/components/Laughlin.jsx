  ...
  return (
    <div className="page">
      ...
      <div className="gallery">
        ...
        <SingleCard quote="I never really thought about it until I was ordered to active duty at Fort Benning, Georgia. And from the day we got there, all that people talked about was Vietnam. I said to myself, What are they so concerned about? It’s just a tiny little conflict in a tiny little country in Indochina, what used to be French Indochina." date="1967" person="James Laughlin" align="align-6" texture="texture-2" />
        <SingleCard quote="I think what was being filtered back to the American public in 1967, when I went on active duty, was a sanitized version of what was actually taking place and that these troop buildups that we were experiencing, which were supposed to be temporary, became permanent and more bloody as time went on." date="1967" person="James Laughlin" align="align-3" texture="texture-2" />
        <SingleCard quote="The first time that I really sat up and said, Whoa, there’s something wrong here was when we got hit with the Tet Offensive in 1968, the first time we were under heavy enemy attack. " date="1968" person="James Laughlin" align="align-3" texture="texture-2" />
        ...
        <SingleCard quote="The whole operational plan was flawed. I don’t think that, given the constraints under which we were operating, that the war was winnable." date="2015" person="James Laughlin" align="align-3" texture="texture-5" />
        <SingleCard quote=" It didn’t take long for those of us who were sent there to realize that we were pawns who really had little control over what we were supposed to be doing, and the name of the game was to survive and help your buddies survive and get home in one piece." date="2015" person="James Laughlin" align="align-1" texture="texture-5" />
        <SingleCard quote="I thought the whole experience, both my personal role and the role of the American armed forces, was a total waste in, first of all, valuable American lives, capital, and in general, in terms of how it affected the fabric of this country and our society, it had an overwhelming impact
"
          date="2015"
          ...
          texture="texture-5"
        />
        <SingleCard quote="I think that, from my own personal feelings, I’m proud of the fact that I served and the men that served with me. I regret that we were involved in a conflict that was so unpopular and didn’t really produce any positive results." date="2015" person="James Laughlin" align="align-7" texture="texture-5" />
        <SingleCard quote="I was diagnosed with Parkinson’s disease in 2006. Around 2008 or 2009, that disease got added to the list of conditions presumptively caused by exposure to Agent Orange, by the Veterans Administration, which was the first time I really came to grips with it and said, Hey, wow! Now I understand, to a certain extent, how this happened to me." date="2015" person="James Laughlin" align="align-7" texture="texture-5" />
      </div>
    </div>
  );
}
