  ...
  return (
    <div className="page">
      ...
      <div className="gallery">
        ...
        <div className="layer-2"><SingleCard quote="I thought the whole experience, both my personal role and the role of the American armed forces, was a total waste in, first of all, valuable American lives, capital, and in general, in terms of how it affected the fabric of this country and our society, it had an overwhelming impact
"
          date="2015"
          ...
          texture="texture-5"
        /></div>
        <div className="I think that, from my own personal feelings, I’m proud of the fact that I served and the men that served with me. I regret that we were involved in a conflict that was so unpopular and didn’t really produce any positive results."><SingleCard quote="d" date="2015" person="James Laughlin" align="align-1" texture="texture-5" /></div>
        <div className="I was diagnosed with Parkinson’s disease in 2006. Around 2008 or 2009, that disease got added to the list of conditions presumptively caused by exposure to Agent Orange, by the Veterans Administration, which was the first time I really came to grips with it and said, Hey, wow! Now I understand, to a certain extent, how this happened to me.
"
        ><SingleCard quote="d" date="2015" person="James Laughlin" align="align-1" texture="texture-5" /></div>
